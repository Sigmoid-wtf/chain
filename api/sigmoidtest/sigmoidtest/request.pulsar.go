...
func init() {
	file_sigmoidtest_sigmoidtest_request_proto_init()
	md_Request = File_sigmoidtest_sigmoidtest_request_proto.Messages().ByName("Request")
...
func (x *Request) slowProtoReflect() protoreflect.Message {
	mi := &file_sigmoidtest_sigmoidtest_request_proto_msgTypes[0]
...
func (x *fastReflection_Request) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sigmoidtest.sigmoidtest.Request.senderAddress":
	...
	default:
		...
		panic(fmt.Errorf("message sigmoidtest.sigmoidtest.Request does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Request) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sigmoidtest.sigmoidtest.Request does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Request) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sigmoidtest.sigmoidtest.Request.senderAddress":
		panic(fmt.Errorf("field senderAddress of message sigmoidtest.sigmoidtest.Request is not mutable"))
	case "sigmoidtest.sigmoidtest.Request.mintAddress":
		panic(fmt.Errorf("field mintAddress of message sigmoidtest.sigmoidtest.Request is not mutable"))
	case "sigmoidtest.sigmoidtest.Request.status":
		panic(fmt.Errorf("field status of message sigmoidtest.sigmoidtest.Request is not mutable"))
	case "sigmoidtest.sigmoidtest.Request.amount":
		panic(fmt.Errorf("field amount of message sigmoidtest.sigmoidtest.Request is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sigmoidtest.sigmoidtest.Request"))
		}
...
func (x *fastReflection_Request) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sigmoidtest.sigmoidtest.Request", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: sigmoidtest/sigmoidtest/request.proto
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_sigmoidtest_sigmoidtest_request_proto_rawDescGZIP(), []int{0}
}
...
var File_sigmoidtest_sigmoidtest_request_proto protoreflect.FileDescriptor

var file_sigmoidtest_sigmoidtest_request_proto_rawDesc = []byte{
	0x0a, 0x25, 0x73, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x73, 0x69,
	0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17, 0x73, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64,
	0x74, 0x65, 0x73, 0x74, 0x2e, 0x73, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74,
	0x22, 0x81, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x0d,
	...
	0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65,
	0x73, 0x74, 0x2f, 0x73, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0xa2, 0x02,
	0x03, 0x53, 0x53, 0x58, 0xaa, 0x02, 0x17, 0x53, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65,
	0x73, 0x74, 0x2e, 0x53, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0xca, 0x02,
	0x17, 0x53, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0x5c, 0x53, 0x69, 0x67,
	0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0xe2, 0x02, 0x23, 0x53, 0x69, 0x67, 0x6d, 0x6f,
	...
	0x18, 0x53, 0x69, 0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0x3a, 0x3a, 0x53, 0x69,
	0x67, 0x6d, 0x6f, 0x69, 0x64, 0x74, 0x65, 0x73, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_sigmoidtest_sigmoidtest_request_proto_rawDescOnce sync.Once
	file_sigmoidtest_sigmoidtest_request_proto_rawDescData = file_sigmoidtest_sigmoidtest_request_proto_rawDesc
)

func file_sigmoidtest_sigmoidtest_request_proto_rawDescGZIP() []byte {
	file_sigmoidtest_sigmoidtest_request_proto_rawDescOnce.Do(func() {
		file_sigmoidtest_sigmoidtest_request_proto_rawDescData = protoimpl.X.CompressGZIP(file_sigmoidtest_sigmoidtest_request_proto_rawDescData)
	})
	return file_sigmoidtest_sigmoidtest_request_proto_rawDescData
}

var file_sigmoidtest_sigmoidtest_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sigmoidtest_sigmoidtest_request_proto_goTypes = []interface{}{
	(*Request)(nil), // 0: sigmoidtest.sigmoidtest.Request
}
var file_sigmoidtest_sigmoidtest_request_proto_depIdxs = []int32{
...
func init() { file_sigmoidtest_sigmoidtest_request_proto_init() }
func file_sigmoidtest_sigmoidtest_request_proto_init() {
	if File_sigmoidtest_sigmoidtest_request_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sigmoidtest_sigmoidtest_request_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sigmoidtest_sigmoidtest_request_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sigmoidtest_sigmoidtest_request_proto_goTypes,
		DependencyIndexes: file_sigmoidtest_sigmoidtest_request_proto_depIdxs,
		MessageInfos:      file_sigmoidtest_sigmoidtest_request_proto_msgTypes,
	}.Build()
	File_sigmoidtest_sigmoidtest_request_proto = out.File
	file_sigmoidtest_sigmoidtest_request_proto_rawDesc = nil
	file_sigmoidtest_sigmoidtest_request_proto_goTypes = nil
	file_sigmoidtest_sigmoidtest_request_proto_depIdxs = nil
}
