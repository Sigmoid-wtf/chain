...
interface IgntStackTransactionsProps {
  className?: string;
}
export default function IgntStackTransactions(props: IgntStackTransactionsProps) {
  ...
  return (
    <section className={props.className ?? ""}>
      <header className="flex items-center justify-between">
        <h2 className="text-3xl text-black font-semibold p-0 m-0 mb-2.5 flex-1">Stack/Unstack Requests</h2>
      </header>
      {txs.length > 0 ? (
