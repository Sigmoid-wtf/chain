...
export default function useSigmoidSigmoid() {
  ...
  return {QueryParams,QueryGetAmount,QueryGetLastProcessed,QueryGetPendingUnstakeRequest,QueryGetRaoStakedBalance,QueryGetSigtaoRateD,QueryGetPendingBridgeRequest,QueryGetLatestProcessedEthBlock,QueryGetFrontPendingStakeRequest,QueryGetFrontPendingUnstakeRequest,
  }
}
